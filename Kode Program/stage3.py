...
def main_3():
    ...
    while running:
        ...
        if info:
            ...
            item_info = pygame.image.load('image/item_info_stage3.png').convert_alpha()
            ...
            item_info = pygame.transform.scale(item_info,(64, 64))

            screen.blit(player_info, (50, 110))
            screen.blit(enemy_info, (50, 185))
            screen.blit(heart_info, (50, 260))
            screen.blit(goal_info, (50, 335))
            screen.blit(item_info, (50, 410))

            font = pygame.font.Font("font/font.ttf", 50)
            stage1_text = font.render("STAGE 3", True, "#D8D9DA")
            stage1_rect = stage1_text.get_rect(center=(screen.get_width() // 2, 90))
            ...
            info_text = [
                ...
                " = AMBIL SENTER UNTUK MENAMBAH AREA PENGLIHATAN",
            ]
